...
public class SetupConeIntake extends SequentialCommandGroup {
  private final TelescopingArm m_TelescopingArm;
  private final PivotArm m_PivotArm;
  /** Creates a new SetupCubeHigh. */
  public SetupConeIntake(TelescopingArm telescopingArm, PivotArm pivotArm) {
    ...
    addCommands(
      ...
      new ParallelAutoScoreSetup(m_PivotArm, m_TelescopingArm, kLowAngleCone, LowExtendCone)
    );
  }
}
