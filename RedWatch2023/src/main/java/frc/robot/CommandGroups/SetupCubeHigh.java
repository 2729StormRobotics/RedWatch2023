...
public class SetupCubeHigh extends SequentialCommandGroup {
  private final TelescopingArm m_TelescopingArm;
  private final PivotArm m_PivotArm;
  /** Creates a new SetupCubeHigh. */
  public SetupCubeHigh(TelescopingArm telescopingArm, PivotArm pivotArm) {
    ...
    addCommands(
      ...
      new ParallelAutoScoreSetup(m_PivotArm, m_TelescopingArm, kHighAngleCube, HighExtendCube)
    );
  }
}
